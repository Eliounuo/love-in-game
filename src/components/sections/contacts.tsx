...
const MAP_EMBED = "https://maps.google.com/maps?q=Кокшетау,+ул.+Уалиханова+212/2,+Казахстан&hl=ru&z=16&output=embed&iwloc=near";
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light text-[#1D1B19] mt-3 leading-tight">
            Найдите нас <span className="italic text-[#B7774E]">в Кокшетау</span>
          </h2>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            {/* Exterior photo */}
            <div className="relative aspect-video rounded-2xl overflow-hidden shadow-lg mt-2">
              <Image
                src={EXTERIOR}
                alt="Love in Game — фасад, ул. Уалиханова 212/2"
                fill
              ...
              <div className="absolute bottom-0 left-0 p-4">
                <p className="text-white font-display text-base">Love in Game</p>
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-80px" }}
            transition={{ duration: 0.6 }}
            className="rounded-3xl overflow-hidden shadow-xl border border-[#B7774E]/10 h-[500px]"
          >
            <iframe
              src={MAP_EMBED}
              width="100%"
